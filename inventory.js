    ...
    if (e.key === 'Enter') {
      if (searchitem.value != '') {
        ...
        for (var i = 0; i < liste.length; i++) {
          ...
          if (price.toString().toLowerCase() == a.toString().toLowerCase() ||barcode.toString().toLowerCase() == a.toString().toLowerCase() || sku.toString().toLowerCase() == a.toString().toLowerCase() || category.toString().toLowerCase() == a.toString().toLowerCase() || color.toString().toLowerCase() == a.toString().toLowerCase() || size.toString().toLowerCase() == a.toString().toLowerCase() || stock.toString().toLowerCase() == a.toString().toLowerCase()) {
